...
export default function Index() {
  ...
  if (!popular.length && !thisWeek.length) {
    return (
      <View style={styles.screenContent}>
        <Text style={styles.bodyText}>No festivals available right now.</Text>
        <Text style={[festivalUi.typography.secondary, styles.subText]}>Please check back later.</Text>
      </View>
    );
  }
